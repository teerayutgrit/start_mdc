                                        ...
                                        <div class="card-body d-flex justify-content-center align-items-center">
                                            <div class="d-grid d-md-block" style="margin:10px 0px 0px 0px; ">
                                                ...
                                                <a class="btn btn-secondary"
                                                    ...
                                                    href="index.php" role="button"><i class="fas fa-reply"></i>
                                                    Black</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="updateproductConfirmationModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <form name="frmMain" action="update_sale_product.php" method="post" id="formupdateproduct01" onsubmit="setProductSeries()">
